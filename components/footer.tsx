        ...
        <div className="flex flex-col space-y-4 md:space-y-0 md:flex-row justify-between md:items-center mt-8">
          ...
          <div>
            <p>
              ...
              <div className="inline-block transform hover:scale-110 hover:-rotate-3 transition duration-300">
                <Link className="hover:bg-red-500 rounded-md px-2 py-1  hover:text-gray-50" href="https://manuarora.in">
                  Manu Arora
                </Link>
              </div>
            </p>
          ...
          {socialLinks && (
            <div className="space-x-4 flex flex-row items-center">
              ...
              {socialLinks.twitter && (
                <Link href={socialLinks.twitter} className="text-base font-normal text-gray-600 dark:text-gray-300">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
              ...
              {socialLinks.linkedin && (
                <Link href={socialLinks.linkedin} className="text-base font-normal text-gray-600 dark:text-gray-300">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
